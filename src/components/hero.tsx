...
const Hero = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] w-full flex items-center justify-center overflow-hidden border-b border-accent">
      <div className="max-w-screen-xl w-full flex flex-col lg:flex-row mx-auto items-center justify-around gap-6 px-6 py-4 lg:py-0">
        ...
        <div className=" mt-7 w-full max-w-md mx-auto bg-background shadow-md rounded-xl border border-border">
  <       LoginForm />
      </div>
      </div>
    </div>

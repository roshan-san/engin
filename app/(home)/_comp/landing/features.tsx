          ...
          <div key={feature.title} className="transform transition-all duration-300 hover:scale-105">
            <Card className="h-full border overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-primary/50">
              <CardHeader className="pb-2">
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${feature.color} transition-transform duration-300 hover:scale-110`}>
                  <feature.icon className="h-6 w-6" />
                </div>
                <Badge variant="outline" className="mb-2">{feature.tagline}</Badge>
                <h3 className="text-xl font-bold tracking-tight transition-colors duration-300 hover:text-primary">
                  {feature.title}
                </h3>
              </CardHeader>
